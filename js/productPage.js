...
(function(){
  var setsCards, productPage_img, productPage_text, productPage_price, productPage_control, loc, logType, logProduct, controlMinus, controlPlus, controlCount;
  setsCards = [
    {
  ...
  if (logType === "set") {
    ...
    controlMinus.onclick = function(){
      if (controlCount.innerText > 1) {
        controlCount.innerText = parseInt(controlCount.innerText - 1);
        return productPage_price.innerText = (parseInt(setsCards[logProduct - 1].price) * parseInt(controlCount.innerText)).toLocaleString('RU-ru') + " 000 сум";
      }
    };
    controlPlus.onclick = function(){
      controlCount.innerText = parseInt(controlCount.innerText) + 1;
      return productPage_price.innerText = (parseInt(setsCards[logProduct - 1].price) * parseInt(controlCount.innerText)).toLocaleString('RU-ru') + " 000 сум";
    };
  }
